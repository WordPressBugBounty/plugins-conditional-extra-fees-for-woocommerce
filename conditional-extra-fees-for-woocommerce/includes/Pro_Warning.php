...
class Pi_CEFW_Pro_Warning{
    ...
    function __construct() {
        add_action( 'after_plugin_row_conditional-extra-fees-for-woocommerce-pro/conditional-fees-rule-woocommerce.php', [$this,'disable_free_version_warning'], 10, 3 );
    }
    ...
    function disable_free_version_warning(){
        ...
        <tr class="plugin-update-tr">
            <td colspan="6" class="plugin-update colspanchange" style="background-color: #ffebe8; border: 1px solid #c00; width:100%; padding:10px;">
                <p>
                    ⚠️ You have Free version of <strong>Conditional extra fees for WooCommerce</strong> active. 
    ...
    function deactivation_link(){
        $free_plugin = 'conditional-extra-fees-for-woocommerce/conditional-fees-rule-woocommerce.php';
...
Pi_CEFW_Pro_Warning::get_instance();
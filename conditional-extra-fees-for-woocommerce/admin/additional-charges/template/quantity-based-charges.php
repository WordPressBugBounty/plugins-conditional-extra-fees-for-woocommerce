...
<div class="row py-3">
    <div class="col-6">
        <a href="javascript:void(0)" class="btn btn-primary btn-sm" id="add_cart_quantity_charges_range"><?php esc_html_e('Add Rule', 'conditional-extra-fees-woocommerce'); ?></a>
    </div>
    <div class="col-6">
...
<template id="cart_quantity_charges_template" >
    <tr>
        <td><?php esc_html_e('Cart Quantity', 'conditional-extra-fees-woocommerce'); ?></td>
...
<table id="cart_quantity_charges_table" class="table">
    <thead>
        <tr>
            ...
            <th class="pi-min-col"><?php esc_html_e('Min Quantity', 'conditional-extra-fees-woocommerce'); ?></th>
            <th class="pi-min-col"><?php esc_html_e('Max Quantity', 'conditional-extra-fees-woocommerce'); ?></th>
            <th class="pi-fee-col"><?php esc_html_e('Fees', 'conditional-extra-fees-woocommerce'); ?> <?php pisol_cefw_help::inline('cart_weight_short_code_help', 'Using short code'); ?></th>
            <th></th>
        </tr>
    </thead>
    <tbody>

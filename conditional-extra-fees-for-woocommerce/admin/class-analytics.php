...
new Pi_Cefw_Analytics(
    'WooCommerce Conditional Extra Fees',
    'conditional-extra-fees-for-woocommerce/conditional-fees-rule-woocommerce.php',
    CONDITIONAL_FEES_RULE_WOOCOMMERCE_VERSION
);